...
<section class="w-full">
    ...
    <x-pages::settings.layout :heading="__('Download archives')" :subheading="__('After nearly 10 years of operation, the database size has reached its limit, so we have decided to delete the oldest data. Here, you can download the data from before the deletion started as a CSV file.')">
